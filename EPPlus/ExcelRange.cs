...
namespace OfficeOpenXml
{
    ...
    public class ExcelRange : ExcelRangeBase
    {
        ...
        public ExcelRange SubRange(int FromRow, int FromCol)
        {
            int newRow = _fromRow + FromRow - 1;
            int newCol = _fromCol + FromCol - 1;
            ValidateRowCol(newRow, newCol);
            return new ExcelRange(Worksheet, newRow, newCol, newRow, newCol);
        }
        #endregion
